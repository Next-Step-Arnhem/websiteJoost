      ...
      <div className="row">
        <div className="col-md-3">
          <div className="review-card border">
            <img src="images/hardrockcafe.png" alt="Illustration 1" />
            <h4>Review 1</h4>
            <p>
        ...
        <div className="col-md-3">
          <div className="review-card border">
            <img src="images/mojo.png" alt="Illustration 2" />
            <h4>Review 2</h4>
            <p>
        ...
        <div className="col-md-3">
          <div className="review-card border">
            <img src="images/dominos.png" alt="Illustration 3" />
            <h4>Review 3</h4>
            <p>
        ...
        <div className="col-md-3 border">
          <div className="review-card">
            <img src="images/okimono.png" alt="Illustration 4" />
            <h4>Review 4</h4>
            <p>
